/*
 * Our Date - Experimental Kakao Map rotation v4
 *
 * v4:
 ...
 *   screen-space marker layer whose POSITION and ORIENTATION follow
 *   the rotated map exactly.
 *
...
(function () {
  ...
  function overrideInfoWindowAnchor() {
    ...
    */
    try {
      ...
      replacement.__ourDateRotationV4Wrapped =
        true;
  ...
  function hookRenderDateMap() {
    ...
    wrapped.__ourDateRotationV4Wrapped =
      true;
